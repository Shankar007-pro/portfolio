              ...
              <div className="space-y-6 break-words">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Phone",
                    content: "+91-9652366210",
                  },
                  {
                    icon: <Linkedin className="w-6 h-6 text-blue-400" />,
                    title: "LinkedIn",
                    content:
                      "https://www.linkedin.com/in/shankareddymopur/",
                    link: true,
                  },
                  {
                    icon: <Github className="w-6 h-6 text-gray-400" />,
                    title: "LeetCode",
                    content: "https://leetcode.com/u/mopurshankar/",
                    link: true,
                  },
                  {
                    icon: <Github className="w-6 h-6 text-gray-400" />,
                  ...
                  },
                  {
                    ...
                    title: "GeeksforGeeks",
                    content:
                      "https://www.geeksforgeeks.org/profile/mopurshanwz7b",
                    link: true,
                  },
                  {
